...
//func (a *HwProvider) GetAvailableImageID(host *v1beta1.Host) (string, error) {
//	if host.OS.ID != "" {
...
//}
//
//func (a *HwProvider) GetDefaultDiskCategories(host *v1beta1.Host) (system []string, data []string) {
...
//}
//
//func (a *HwProvider) GetAvailableInstanceType(host *v1beta1.Host) ([]string, error) {
//	if host.EcsType != "" {
