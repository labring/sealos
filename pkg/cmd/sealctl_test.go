...
func Test_sealctl_ConfigInit(t *testing.T) {
	tests := []struct {
		name    string
		want    string
		wantErr bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := &sealctl{}
			got, err := s.ConfigInit()
			if (err != nil) != tt.wantErr {
				t.Errorf("ConfigInit() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("ConfigInit() got = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_sealctl_ConfigJoinMaster(t *testing.T) {
	tests := []struct {
		name    string
		want    string
		wantErr bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := &sealctl{}
			got, err := s.ConfigJoinMaster()
			if (err != nil) != tt.wantErr {
				t.Errorf("ConfigJoinMaster() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("ConfigJoinMaster() got = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_sealctl_ConfigJoinNode(t *testing.T) {
	tests := []struct {
		name    string
		want    string
		wantErr bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := &sealctl{}
			got, err := s.ConfigJoinNode()
			if (err != nil) != tt.wantErr {
				t.Errorf("ConfigJoinNode() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("ConfigJoinNode() got = %v, want %v", got, tt.want)
			}
		})
	}
}
