...
//+kubebuilder:rbac:groups=imagehub.sealos.io,resources=counters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=imagehub.sealos.io,resources=counters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=imagehub.sealos.io,resources=counters/finalizers,verbs=update
