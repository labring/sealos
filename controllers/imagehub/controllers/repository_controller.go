...
//+kubebuilder:rbac:groups=imagehub.sealos.io,resources=repositries,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=imagehub.sealos.io,resources=repositries/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=imagehub.sealos.io,resources=repositries/finalizers,verbs=update
...
func (r *RepositoryReconciler) spec2Status(ctx context.Context, repo *imagehubv1.Repository) error {
	...
	repo.Status.Tags = repo.Spec.Tags
	return nil
}

// addLable add lable to image.
func (r *RepositoryReconciler) addLable(ctx context.Context, repo *imagehubv1.Repository) error {
	if repo.Labels == nil {
		repo.Labels = map[string]string{}
	}
	repo.Labels[imagehubv1.HubSealosOrgLabel] = repo.Spec.Name.GetOrg()
	repo.Labels[imagehubv1.HubSealosRepoLabel] = repo.Spec.Name.GetRepo()
