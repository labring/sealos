...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CounterInfo) DeepCopyInto(out *CounterInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CounterInfo.
func (in *CounterInfo) DeepCopy() *CounterInfo {
	if in == nil {
		return nil
	}
	out := new(CounterInfo)
...
func (in *FullData) DeepCopyInto(out *FullData) {
	*out = *in
	...
	if in.CounterInfo != nil {
		in, out := &in.CounterInfo, &out.CounterInfo
		*out = make(map[CounterType]CounterInfo, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
