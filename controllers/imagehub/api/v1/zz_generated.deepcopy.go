...
func (in *AppActions) DeepCopyInto(out *AppActions) {
	*out = *in
	if in.Actions != nil {
		in, out := &in.Actions, &out.Actions
		*out = make(map[ActionName]Template, len(*in))
	...
	if in.CMD != nil {
		...
		*out = make(map[ActionName]CMD, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppActions.
func (in *AppActions) DeepCopy() *AppActions {
	if in == nil {
		return nil
	}
	out := new(AppActions)
...
func (in *ImageDetailInfo) DeepCopyInto(out *ImageDetailInfo) {
	*out = *in
	...
	in.AppActions.DeepCopyInto(&out.AppActions)
}
