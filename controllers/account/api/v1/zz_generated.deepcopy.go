...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccountBalanceSpecInline) DeepCopyInto(out *AccountBalanceSpecInline) {
	*out = *in
	if in.Costs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccountBalanceSpecInline.
func (in *AccountBalanceSpecInline) DeepCopy() *AccountBalanceSpecInline {
	if in == nil {
		return nil
	}
	out := new(AccountBalanceSpecInline)
	in.DeepCopyInto(out)
	return out
}
