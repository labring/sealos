...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *I18nData) DeepCopyInto(out *I18nData) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new I18nData.
func (in *I18nData) DeepCopy() *I18nData {
	if in == nil {
		return nil
	}
	out := new(I18nData)
...
func (in *TemplateData) DeepCopyInto(out *TemplateData) {
	*out = *in
	if in.I18n != nil {
		in, out := &in.I18n, &out.I18n
		*out = make(map[string]I18nData, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
