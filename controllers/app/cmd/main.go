...
import (
	...
	"github.com/labring/sealos/controllers/pkg/license"
	...
	metricsserver "sigs.k8s.io/controller-runtime/pkg/metrics/server" //+kubebuilder:scaffold:imports
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f3e714c5.sealos.io",
	...
	licenseCheck := license.NewLicenseChecker(mgr.GetClient()).Checker()
	if err := mgr.AddHealthzCheck("healthz", licenseCheck); err != nil {
		setupLog.Error(err, "unable to set up health check")
		os.Exit(1)
	}
	if err := mgr.AddReadyzCheck("readyz", licenseCheck); err != nil {
