...
func (in *ApplyLicense) DeepCopyInto(out *ApplyLicense) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplyLicense.
func (in *ApplyLicense) DeepCopy() *ApplyLicense {
	if in == nil {
		return nil
	}
	out := new(ApplyLicense)
	in.DeepCopyInto(out)
	return out
}
