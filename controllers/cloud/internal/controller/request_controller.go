...
//+kubebuilder:rbac:groups=request.sealos.io,resources=requests,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=request.sealos.io,resources=requests/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=request.sealos.io,resources=requests/finalizers,verbs=update
