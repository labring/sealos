...
type WorkspaceSubscription struct {
	...
	Workspace     string                 `gorm:"type:varchar(50);column:workspace;uniqueIndex:idx_workspace_region"`
	RegionDomain  string                 `gorm:"type:varchar(50);column:region_domain;uniqueIndex:idx_workspace_region"`
...
type WorkspaceSubscriptionTransaction struct {
	...
	Workspace     string                        `gorm:"type:varchar(50);not null;index:idx_workspace_region;column:workspace"` // Workspace 名称
	RegionDomain  string                        `gorm:"type:varchar(50);not null;index;column:region_domain"`                  // Region Domain
