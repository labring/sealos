...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in IndexDisks) DeepCopyInto(out *IndexDisks) {
	{
		in := &in
		*out = make(IndexDisks, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IndexDisks.
func (in IndexDisks) DeepCopy() IndexDisks {
	if in == nil {
		return nil
	}
	out := new(IndexDisks)
