			...
			Containers: []corev1.Container{
				{
					...
					//		Name: "PROXY_SERVER",
					//		//should be ingress
					//		Value: devbox.Name + "-proxy-svc",
					//	},
					//	{
					//		Name:  "SSH_SERVER",
					//		Value: devbox.Name + "-pod-svc" + ":" + sshPort,
					//	},
					//	{
					//		Name:  "LOCAL_PORT",
					//		Value: "2222",
					...
					Args: []string{
						fmt.Sprintf("/app/bin server --port=%d --proxy=https://%s-pod-svc:%s -v=true --reverse & /app/bin client -v localhost:%d R:2222:192.168.10.63",
							8080,
							devbox.Name,
							sshPort,
							8080,
