...
// use devbox.Spec.Config.Env, generate a profile.d script
func GenerateEnvProfile(devbox *devboxv1alpha1.Devbox, devboxJWTSecret []byte) []byte {
...
func GenerateEnvProfileVolume(devbox *devboxv1alpha1.Devbox) corev1.Volume {
	return corev1.Volume{
		Name: "devbox-env-profile",
		VolumeSource: corev1.VolumeSource{
			Secret: &corev1.SecretVolumeSource{
