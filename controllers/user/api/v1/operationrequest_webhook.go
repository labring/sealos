...
var _ webhook.Defaulter = &Operationrequest{}

// Default implements webhook.Defaulter so a webhook will be registered for the type
func (r *Operationrequest) Default() {
	operationrequestlog.Info("default", "name", r.Name)
...
var _ webhook.Validator = &Operationrequest{}

// ValidateCreate implements webhook.Validator so a webhook will be registered for the type
func (r *Operationrequest) ValidateCreate() error {
	operationrequestlog.Info("validate create", "name", r.Name)
...
func (r *Operationrequest) ValidateUpdate(old runtime.Object) error {
	operationrequestlog.Info("validate update", "name", r.Name)
...
func (r *Operationrequest) ValidateDelete() error {
	operationrequestlog.Info("validate delete", "name", r.Name)
