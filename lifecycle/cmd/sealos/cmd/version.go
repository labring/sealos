...
func PrintInfo() error {
	info := &version.Output{}
	info.SealosVersion = version.Get()
	...
	info.KubernetesVersion = versionutils.GetKubernetesVersion(cluster)
	info.CriRuntimeVersion = versionutils.GetCriRuntimeVersion()
