...
```tsx
// pages/_document.tsx
import { getGTMScripts, getDataLayerScript } from '@labring/gtm';
...
```tsx
import { track, GTMEvent, DeploymentCreateEvent } from '@labring/gtm';
...
```tsx
import { configureGTM } from '@labring/gtm';
