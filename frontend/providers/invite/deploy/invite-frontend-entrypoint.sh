...
add_set_string inviteConfig.cloudDomain "${CONFIG_CLOUD_DOMAIN:-${cloudDomain:-}}"
add_set_string inviteConfig.cloudPort "${CONFIG_CLOUD_PORT:-${cloudPort:-}}"
add_set_string inviteConfig.httpPort "${CONFIG_HTTP_PORT:-${httpPort:-}}"
add_set_string inviteConfig.disableHttps "${CONFIG_DISABLE_HTTPS:-${disableHttps:-}}"
add_set_string inviteConfig.certSecretName "${CONFIG_CERT_SECRET_NAME:-${certSecretName:-}}"
add_set_string inviteConfig.lafBaseUrl "${lafBaseUrl:-}"
add_set_string inviteConfig.giftRatio "${giftRatio:-}"
add_set_string inviteConfig.inviterReward "${inviterReward:-}"
