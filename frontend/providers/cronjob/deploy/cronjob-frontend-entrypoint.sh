...
add_set_string cronjobConfig.cloudDomain "${CONFIG_CLOUD_DOMAIN:-${cloudDomain:-}}"
add_set_string cronjobConfig.cloudPort "${CONFIG_CLOUD_PORT:-${cloudPort:-}}"
add_set_string cronjobConfig.httpPort "${CONFIG_HTTP_PORT:-${httpPort:-}}"
add_set_string cronjobConfig.disableHttps "${CONFIG_DISABLE_HTTPS:-${disableHttps:-}}"
add_set_string cronjobConfig.certSecretName "${CONFIG_CERT_SECRET_NAME:-${certSecretName:-}}"
add_set_string cronjobConfig.successfulJobsHistoryLimit "${SUCCESSFUL_JOBS_HISTORY_LIMIT:-}"
add_set_string cronjobConfig.failedJobsHistoryLimit "${FAILED_JOBS_HISTORY_LIMIT:-}"
