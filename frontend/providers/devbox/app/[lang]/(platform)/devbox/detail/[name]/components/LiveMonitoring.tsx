...
const LiveMonitoring = () => {
  ...
  return (
    <div className="flex h-[200px] flex-col items-start gap-5 rounded-xl border-[0.5px] bg-white p-6 shadow-xs">
      {/* title */}
      ...
      <div className="flex min-h-[100px] w-full gap-5">
        <div className="flex w-[18vw] shrink-0 grow flex-col gap-2">
