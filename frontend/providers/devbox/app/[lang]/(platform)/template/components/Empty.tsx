...
const Empty = ({ description }: { description?: string }) => {
  ...
  return (
    <div
      className="relative flex h-[calc(100vh-300px)] flex-1 flex-col items-center justify-center"
      data-testid="template-page.empty"
    >
      <Image width={900} height={328} alt={'template-empty'} src={'/images/template-empty.svg'} />
      <div className="absolute left-1/2 top-1/2 flex w-[292px] -translate-x-1/2 translate-y-[10%] flex-col items-center gap-1">
