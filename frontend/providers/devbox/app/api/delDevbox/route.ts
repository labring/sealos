...
import { isDevboxOwnerReferencesReady } from '@/services/backend/ownerReferences';
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    let ownerReferencesReady = false;
    try {
      ...
      ownerReferencesReady = isDevboxOwnerReferencesReady(devboxBody);
    } catch (error) {
      console.warn('Failed to check devbox ownerReferences status:', devboxName, error);
    }
