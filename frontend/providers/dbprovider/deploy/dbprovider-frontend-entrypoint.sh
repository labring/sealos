...
add_enforced_set_string dbproviderConfig.tlsRejectUnauthorized "${tls_reject_unauthorized}"
...
USER_VALUES_PATH="/root/.sealos/cloud/values/apps/database/dbprovider-values.yaml"
