...
## [v5.1.0-beta1](https://github.com/labring/sealos/compare/v5.0.1...v5.1.0-beta1) (2025-08-20)

### Add

* gtm ([#5658](https://github.com/labring/sealos/issues/5658))

### Chore

* Update self-host links
* update version ([#5707](https://github.com/labring/sealos/issues/5707))
* Update DevBox extension ReadMe ([#5665](https://github.com/labring/sealos/issues/5665))
* optimize app deletion warning message ([#5540](https://github.com/labring/sealos/issues/5540))
* version info adjust ([#5257](https://github.com/labring/sealos/issues/5257))
* prettier all code ([#5353](https://github.com/labring/sealos/issues/5353))
* Update i18n en strings ([#5387](https://github.com/labring/sealos/issues/5387))
* Update deploy links
* Update README.md
* Update ReadMe links
* Update ReadMe ([#5418](https://github.com/labring/sealos/issues/5418))
* bump golangci-lint and semgrep version ([#5404](https://github.com/labring/sealos/issues/5404))
* Update ReadMe ([#5370](https://github.com/labring/sealos/issues/5370))
* **account-service:** Add aiproxy backend real name lookup interface ([#5394](https://github.com/labring/sealos/issues/5394))
* **account-service:** add enterprise real name info inquiry ([#5363](https://github.com/labring/sealos/issues/5363))
* **aiproxy:** adjust price display and add sline interface ([#5542](https://github.com/labring/sealos/issues/5542))
* **devbox:** deploy yaml update ([#5489](https://github.com/labring/sealos/issues/5489))
* **license:** replace Apache License with Sealos Sustainable Use License ([#5788](https://github.com/labring/sealos/issues/5788))
* **twitter:** update Twitter handle to [@Sailos_io](https://github.com/Sailos_io) ([#5335](https://github.com/labring/sealos/issues/5335))

### Ci

* update `upload-artifact` and `download-artifact` actions to v4 ([#5212](https://github.com/labring/sealos/issues/5212))
* cloud release add skip releases. ([#5135](https://github.com/labring/sealos/issues/5135))
* cloud release add self hosted runner. ([#5131](https://github.com/labring/sealos/issues/5131))

### Config

* Automated Tagpr Update for v5.1.0-beta1 ([#5824](https://github.com/labring/sealos/issues/5824))

### Doc

* add devbox doc ([#5210](https://github.com/labring/sealos/issues/5210))
* **devbox:** add fqa in devbox doc ([#5289](https://github.com/labring/sealos/issues/5289))

### Docs

* update contribution policy and guidelines in README ([#5741](https://github.com/labring/sealos/issues/5741))
* delete docs/blog. ([#5329](https://github.com/labring/sealos/issues/5329))
* change blog url ([#5251](https://github.com/labring/sealos/issues/5251))
* add ai-proxy.md ([#5233](https://github.com/labring/sealos/issues/5233))
* Update docs scripts ([#5181](https://github.com/labring/sealos/issues/5181))
* add v5.0.1 zh-hans docs. ([#5165](https://github.com/labring/sealos/issues/5165))
* update links ([#5128](https://github.com/labring/sealos/issues/5128))
* **frontend:** rewrite frontend dev env setup docs ([#5662](https://github.com/labring/sealos/issues/5662))
* **website:** Update announcement bar with dynamic content ([#5313](https://github.com/labring/sealos/issues/5313))

### Docs

* add vercel.json ([#5311](https://github.com/labring/sealos/issues/5311))
* update blog url ([#5248](https://github.com/labring/sealos/issues/5248))
...
* support pay refund ([#5705](https://github.com/labring/sealos/issues/5705))
* llm token account service ([#5202](https://github.com/labring/sealos/issues/5202))

### Fix

* Document typo error ([#5254](https://github.com/labring/sealos/issues/5254))
* hide language switch button in template ([#5190](https://github.com/labring/sealos/issues/5190))
...
* remove --masters and --nodes options for reset ([#5148](https://github.com/labring/sealos/issues/5148))
...
* mv aiproxy to labring/aiproxy ([#5458](https://github.com/labring/sealos/issues/5458))

### Step1

* copy runtime config to devbox crd, add runtime id. ([#5326](https://github.com/labring/sealos/issues/5326))

### Step2

* change pod create logic from devbox config, delete runtime and runtimeclass crd. ([#5328](https://github.com/labring/sealos/issues/5328))

### Style

* **costcenter:** fix ratio ([#5175](https://github.com/labring/sealos/issues/5175))
* **costcenter:** recharge discount ([#5129](https://github.com/labring/sealos/issues/5129))

### Update

* devbox deploy.yaml.tmpl to build latest cluster image ([#5544](https://github.com/labring/sealos/issues/5544))

### Upgrade

* controller runtime version ([#5597](https://github.com/labring/sealos/issues/5597))
