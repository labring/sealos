...
const FrontPage = () => {
	...
	return (
		<div className="pagecont w-full absolute top-0">
			<div
				id="apprib"
				className={clsx(styles.amzApps, styles.frontCont, ' my-8 py-20 w-auto mx-8 \
        flex justify-between noscroll overflow-x-scroll overflow-y-hidden')}
			...
			<div
				id="gamerib"
				className={clsx(styles.frontCont, styles.amzGames, "my-8 py-20 w-auto mx-8 \
        flex justify-between noscroll overflow-x-scroll overflow-y-hidden")}
			>
				<div className="flex w-64 flex-col text-gray-100 h-full px-8">
			...
			<div
				id="movrib"
				className={clsx(styles.frontCont, styles.amzMovies, "frontCont amzMovies my-8 py-20 w-auto mx-8 \
        flex justify-between noscroll overflow-x-scroll overflow-y-hidden")}
			>
				<div className="flex w-64 flex-col text-gray-100 h-full px-8">
