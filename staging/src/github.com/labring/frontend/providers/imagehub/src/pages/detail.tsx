...
import { formattedSize, handleImageName, TAppDetail } from '@/interfaces/imagehub';
...
export default function DetailPage() {
  ...
  const detailAppName = router.query.imageName as string;
    ...
    return (
      <div className={clsx(styles.backgroundWrap, 'flex flex-col grow h-full p-8 pb-0')}>
        <div className={clsx(styles.baseCard, styles.appHeader, 'w-full')}>
          <div className={clsx('cursor-pointer w-60')} onClick={() => router.push('/')}>
  ...
  return (
    <div className={clsx(styles.backgroundWrap, 'flex flex-col grow h-full px-8 pb-0')}>
      <div className={clsx(styles.baseCard, styles.appHeader, 'w-full')}>
        <div className={clsx('cursor-pointer w-60')} onClick={() => router.push('/')}>
          <Iconfont iconName="icon-back2" color="#717D8A" />
        </div>
        <div className={clsx(styles.appInfo, { [styles.fixed]: isFixed })}>
          <div className={clsx(styles.image, 'flex items-center justify-center shrink-0')}>
            <img src={appDetail?.icon ?? '/images/image_empty.svg'} alt={appDetail?.name} />
          </div>
