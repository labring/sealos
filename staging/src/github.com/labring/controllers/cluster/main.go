...
import (
	...
	utilcontroller "github.com/labring/sealos/controllers/pkg/utils/rate"
	...
	"github.com/labring/sealos/controllers/cluster/controllers"
...
func init() {
	...
	utilruntime.Must(iv1.AddToScheme(scheme))
...
func main() {
	var (
		...
		probeAddr            string
		concurrent           int
		rateLimiterOptions   utilcontroller.LimiterOptions
	)
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4c1c3188.sealos.io",
